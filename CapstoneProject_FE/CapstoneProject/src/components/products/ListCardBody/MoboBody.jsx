        ...
        <div className="d-flex justify-content-between align-items-start mb-2">
          <div>
           ...
           <div className="d-flex  row row-cols-2">
              <div><span className="text-light opacity-75">Socket:</span>{" "}<span className="text-light fw-bold">{product.socket}</span></div>
              <div><span className="text-light opacity-75">Form Factor:</span>{" "}<span className="text-light fw-bold">{product.formFactor}</span></div>
              <div><span className="text-light opacity-75">Max Ram:</span>{" "}<span className="text-light fw-bold">{product.maxRam} Gb</span></div>
              <div><span className="text-light opacity-75">Ram Type:</span>{" "}<span className="text-light fw-bold">{product.ramType}</span></div>
              <div><span className="text-light opacity-75">Ram Slots:</span>{" "}<span className="text-light fw-bold">{product.ramSlots}</span></div>
           </div>
          </div>
