...
import { GetAllRamType } from "../../../redux/actions/BackofficeApi";
...
const handleFetch = async () => {
    const data = await GetAllRamType()
    setSockets(data)
}  
...
: <></>
    ...
    <h5 className="text-light mb-0">Ram Type Management</h5>
    </Card.Header>
    <Card.Body>
