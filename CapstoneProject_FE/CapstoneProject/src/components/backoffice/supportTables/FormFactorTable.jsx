...
import { GetAllFormFactor } from "../../../redux/actions/BackofficeApi";

const FormFactorTable = () => {
...
const handleFetch = async () => {
    const data = await GetAllFormFactor()
    setSockets(data)
}  
...
: <></>
    ...
    <h5 className="text-light mb-0">Form Factor Management</h5>
    </Card.Header>
    <Card.Body>
...
export default FormFactorTable;