...
export const ExportToText = (build , total = build.totalPrice) =>{
    console.log(build);
...
Total Price: €${total.toFixed(2) || 'N/A'}
Created: ${build.createdAt ? new Date(build.createdAt).toLocaleDateString() : new Date().toLocaleDateString() } `
}